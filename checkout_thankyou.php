			...
			<div>
				<section class="thankyou-container">
					<?php if ($_GET['result']) : ?>
						...
						<h2>Bạn có thể truy cập trang đơn đặt hàng của mình </br>để theo dõi giao hàng mua hàng của bạn</h2>
					...
					<?php else : ?>
						<h1>
							Giao dịch mua hàng của bạn không được gửi vì những lý do không mong muốn 😞
							<br>
							Thử lại sau
						</h1>
						<a href="./" class="styled-btn">
